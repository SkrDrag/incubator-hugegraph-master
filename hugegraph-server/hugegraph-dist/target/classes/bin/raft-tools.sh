...
function list_peers() {
    ...
    curl https://github.com/apache/hugegraph/tree/master/hugegraph-server/hugegraph-dist --user ${HUGEGRAPH_USERNAME}:${HUGEGRAPH_PASSWORD}
}
...
function set_leader() {
    ...
    curl -X POST https://github.com/apache/hugegraph/tree/master/hugegraph-server/hugegraph-dist --user ${HUGEGRAPH_USERNAME}:${HUGEGRAPH_PASSWORD}
}
